        ...
        <div class="container-fluid">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 home-about-right no-padding">
                    ...
                    <a href="/adminAnimalsGallery.php" class="primary-btn text-uppercase">Найти друга</a>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col-lg-6 home-about-right no-padding">
                    <?php foreach ($aboutIcon as $icon): ?>
                        <ul>
                            <li>
                                <div class="row align-items-center">
                                    <div class="col-lg-2 col-md-6 no-padding row-height">
                                        <img src="<?= $icon ? '../../img/' . $icon->Photo : '' ?>" alt="">
                                    </div>
                                    <div class="col-lg-10 col-md-6 row-padding">
                                        <?= $icon->Description ?>
                                    </div>
                                </div>
                            </li>
