                ...
                <div class="single-footer-widget">
                    ...
                    <div class="row">
                        <ul class="col footer-nav">
                            <li class="menu-active"><a href="/index.php">О приюте</a></li>
                            <li class="menu-has-children"><a href="/cats.php">Коты</a>
                            <li class="menu-has-children"><a href="/dogs.php">Собаки</a>
                            <li class="menu-has-children"><a href="/otherAnimals.php">Другие животные</a>
                        </ul>
                        <ul class="col footer-nav">
                            <li class="menu-has-children"><a href="/article.php">Полезные статьи</a></li>
                            <li class="menu-has-children"><a href="/volunteer.php">Волонтерство</a></li>
                            <li class="menu-has-children"><a href="/donat.php">Помощь приюту</a></li>
                            <li class="menu-has-children"><a href="/happyEnd.php">Happy End</a></li>
                        </ul>
                    </div>
                </div>
            </div>
